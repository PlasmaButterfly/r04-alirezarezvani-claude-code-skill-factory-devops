        ---
        name: "r00-alirezarezvani-claude-code-skill-factory--devops"
        description: >
          ☁️ DevOps & Cloud Infrastructure skill suite derived from alirezarezvani/claude-code-skill-factory.
